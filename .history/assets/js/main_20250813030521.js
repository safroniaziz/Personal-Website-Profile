(function(){
  ...
  function applyTranslations(lang) {
    ...
    // Update hero section
    const openToOpportunities = document.querySelector('#home .inline-flex span:last-child');
    if (openToOpportunities) openToOpportunities.textContent = langData.openToOpportunities;
    ...
    const webAppDevelopmentText = document.querySelector('#experience .text-slate-700:contains("Web application development")');
    if (webAppDevelopmentText) webAppDevelopmentText.textContent = langData.webAppDevelopment;
    
    const integrationNetGoText = document.querySelector('#experience .text-slate-700:contains("Integration with .NET")');
    if (integrationNetGoText) integrationNetGoText.textContent = langData.integrationNetGo;
    
    const tailwindImplementationText = document.querySelector('#experience .text-slate-700:contains("Tailwind CSS")');
    if (tailwindImplementationText) tailwindImplementationText.textContent = langData.tailwindImplementation;
