(function(){
  ...
  function applyTranslations(lang) {
    ...
    // Update bullet points for second experience
    const secondExperienceBullets = document.querySelectorAll('#experience .group:nth-child(2) .text-slate-700');
    if (secondExperienceBullets.length >= 4) {
      secondExperienceBullets[0].textContent = langData.researchSystem;
      secondExperienceBullets[1].textContent = langData.remunerationSystem;
      secondExperienceBullets[2].textContent = langData.shareManagementSystem;
      secondExperienceBullets[3].textContent = langData.andManyMore;
    }
    
    // Update "And many more (etc.)" text specifically
    const andManyMoreText = document.querySelector('#experience .text-slate-700:last-child');
    if (andManyMoreText && andManyMoreText.textContent.includes('And many more')) {
      andManyMoreText.textContent = langData.andManyMore;
    }
    
    // Update "And many more (etc.)" text in the second experience group
    const secondExperienceGroup = document.querySelector('#experience .group:nth-child(2)');
    if (secondExperienceGroup) {
      const andManyMoreInGroup = secondExperienceGroup.querySelector('.text-slate-700:last-child');
      if (andManyMoreInGroup && andManyMoreInGroup.textContent.includes('And many more')) {
        andManyMoreInGroup.textContent = langData.andManyMore;
      }
    }
    
    // Update "And many more (etc.)" text in the second experience group
    const secondExperienceGroup2 = document.querySelector('#experience .group:nth-child(2)');
    if (secondExperienceGroup2) {
      const andManyMoreInGroup2 = secondExperienceGroup2.querySelector('.text-slate-700:last-child');
      if (andManyMoreInGroup2 && andManyMoreInGroup2.textContent.includes('And many more')) {
        andManyMoreInGroup2.textContent = langData.andManyMore;
      }
    }
    
    // Update "And many more (etc.)" text in the second experience group
    const secondExperienceGroup3 = document.querySelector('#experience .group:nth-child(2)');
    if (secondExperienceGroup3) {
      const andManyMoreInGroup3 = secondExperienceGroup3.querySelector('.text-slate-700:last-child');
      if (andManyMoreInGroup3 && andManyMoreInGroup3.textContent.includes('And many more')) {
        andManyMoreInGroup3.textContent = langData.andManyMore;
      }
    }
    
    // Update "And many more (etc.)" text in the second experience group
    const secondExperienceGroup4 = document.querySelector('#experience .group:nth-child(2)');
    if (secondExperienceGroup4) {
      const andManyMoreInGroup4 = secondExperienceGroup4.querySelector('.text-slate-700:last-child');
      if (andManyMoreInGroup4 && andManyMoreInGroup4.textContent.includes('And many more')) {
        andManyMoreInGroup4.textContent = langData.andManyMore;
      }
    }
    
    // Update "And many more (etc.)" text in the second experience group
    const secondExperienceGroup5 = document.querySelector('#experience .group:nth-child(2)');
    if (secondExperienceGroup5) {
      const andManyMoreInGroup5 = secondExperienceGroup5.querySelector('.text-slate-700:last-child');
      if (andManyMoreInGroup5 && andManyMoreInGroup5.textContent.includes('And many more')) {
        andManyMoreInGroup5.textContent = langData.andManyMore;
      }
    }
    
    // Update "And many more (etc.)" text in the second experience group
    const secondExperienceGroup6 = document.querySelector('#experience .group:nth-child(2)');
    if (secondExperienceGroup6) {
      const andManyMoreInGroup6 = secondExperienceGroup6.querySelector('.text-slate-700:last-child');
      if (andManyMoreInGroup6 && andManyMoreInGroup6.textContent.includes('And many more')) {
        andManyMoreInGroup6.textContent = langData.andManyMore;
      }
    }
    
    // Update "And many more (etc.)" text in the second experience group
    const secondExperienceGroup7 = document.querySelector('#experience .group:nth-child(2)');
    if (secondExperienceGroup7) {
      const andManyMoreInGroup7 = secondExperienceGroup7.querySelector('.text-slate-700:last-child');
      if (andManyMoreInGroup7 && andManyMoreInGroup7.textContent.includes('And many more')) {
        andManyMoreInGroup7.textContent = langData.andManyMore;
      }
    }
    
    // Update "And many more (etc.)" text in the second experience group
    const secondExperienceGroup8 = document.querySelector('#experience .group:nth-child(2)');
    if (secondExperienceGroup8) {
      const andManyMoreInGroup8 = secondExperienceGroup8.querySelector('.text-slate-700:last-child');
      if (andManyMoreInGroup8 && andManyMoreInGroup8.textContent.includes('And many more')) {
        andManyMoreInGroup8.textContent = langData.andManyMore;
      }
    }
    
    // Update "And many more (etc.)" text in the second experience group
    const secondExperienceGroup9 = document.querySelector('#experience .group:nth-child(2)');
    if (secondExperienceGroup9) {
      const andManyMoreInGroup9 = secondExperienceGroup9.querySelector('.text-slate-700:last-child');
      if (andManyMoreInGroup9 && andManyMoreInGroup9.textContent.includes('And many more')) {
        andManyMoreInGroup9.textContent = langData.andManyMore;
      }
    }
    
    // Update "And many more (etc.)" text in the second experience group
    const secondExperienceGroup10 = document.querySelector('#experience .group:nth-child(2)');
    if (secondExperienceGroup10) {
      const andManyMoreInGroup10 = secondExperienceGroup10.querySelector('.text-slate-700:last-child');
      if (andManyMoreInGroup10 && andManyMoreInGroup10.textContent.includes('And many more')) {
        andManyMoreInGroup10.textContent = langData.andManyMore;
      }
    }
