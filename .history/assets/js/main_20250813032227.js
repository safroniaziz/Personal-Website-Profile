(function(){
  ...
  function applyTranslations(lang) {
    ...
    // Update all "And many more" texts in experience section
    const allAndManyMoreTexts = document.querySelectorAll('#experience .text-slate-700');
    allAndManyMoreTexts.forEach(text => {
      if (text.textContent.includes('And many more')) {
        text.textContent = langData.andManyMore;
      }
    });
